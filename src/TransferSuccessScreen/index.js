...
export default function TransferSuccessScreen({ navigation }){
    return (
      <View style={{ paddingHorizontal: 8, marginTop: 16, flex: 1 }}>
        ...
        <View style={{ flex: 2 }}>
          <Text style={{ textAlign: 'center', fontSize: 24, marginBottom: 8 }}>Transfer Berhasil!</Text>
          <Text style={{ textAlign: 'center', fontSize: 24, marginBottom: 8 }}>Rp. 100,000</Text>
          <View style={{ paddingLeft: 8, paddingRight: 8, paddingTop: 16, paddingBottom: 16, backgroundColor: '#4982C1' }}>
            ...
            <Text style={{ color: '#FFFFFF', textAlign: 'center', marginBottom: 8, fontWeight: 'bold' }}>Dendy Aditya</Text>
